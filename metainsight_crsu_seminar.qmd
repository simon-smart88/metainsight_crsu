...
- Studies can be excluded from analyses to examine their influence on the result
...
<div style="display: flex; justify-content: center; margin-top: -80px">
  <img src="images/metainsight_existing_exclusions.png" width = 1400 alt = "Screenshot of the existing app">
</div>
...
<iframe width="1000" height="700" src="report.html"></iframe>
...
- Reuse plots from other packages
- Mixture of base plots and ggplot2 
...
- Plots generated as SVGs by functions 
